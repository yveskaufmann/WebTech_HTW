...
class PollTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Poller.App.Model.Map.PollTableMap';
     ...
     */
    const OM_CLASS = '\\Poller\\App\\Model\\Poll';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Poller.App.Model.Poll';
     ...
     */
    const COL_ID = 'Poll.id';

    /**
     * the column name for the question field
     */
    const COL_QUESTION = 'Poll.question';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Question', ),
        self::TYPE_CAMELNAME     => array('id', 'question', ),
        self::TYPE_COLNAME       => array(PollTableMap::COL_ID, PollTableMap::COL_QUESTION, ),
        self::TYPE_FIELDNAME     => array('id', 'question', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Question' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'question' => 1, ),
        self::TYPE_COLNAME       => array(PollTableMap::COL_ID => 0, PollTableMap::COL_QUESTION => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'question' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Poller\\App\\Model\\Poll');
    ...
    {
        $this->addRelation('PollAnswer', '\\Poller\\App\\Model\\PollAnswer', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':poll',
    1 => ':id',
  ),
), null, null, 'PollAnswers', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PollTableMap::COL_QUESTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Poller\App\Model\Poll) { // it's a model object
