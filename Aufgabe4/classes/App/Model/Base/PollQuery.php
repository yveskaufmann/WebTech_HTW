 ...
 *
 * @method     \Poller\Model\PollAnswerQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PollQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Poller\Model\Base\PollQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'poller', $modelName = '\\Poller\\Model\\Poll', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Poller\Model\PollAnswer object
     *
     * @param \Poller\Model\PollAnswer|ObjectCollection $pollAnswer the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($pollAnswer instanceof \Poller\Model\PollAnswer) {
            return $this
            ...
            throw new PropelException('filterByPollAnswer() only accepts arguments of type \Poller\Model\PollAnswer or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Poller\Model\PollAnswerQuery A secondary query class using the current class as primary query
     */
    public function usePollAnswerQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPollAnswer($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PollAnswer', '\Poller\Model\PollAnswerQuery');
    }
