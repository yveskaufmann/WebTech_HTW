 ...
 *
 * @method     \Poller\Model\PollQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PollAnswerQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Poller\Model\Base\PollAnswerQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'poller', $modelName = '\\Poller\\Model\\PollAnswer', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Poller\Model\Poll object
     *
     * @param \Poller\Model\Poll|ObjectCollection $poll The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($poll instanceof \Poller\Model\Poll) {
            return $this
            ...
            throw new PropelException('filterByPoll() only accepts arguments of type \Poller\Model\Poll or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Poller\Model\PollQuery A secondary query class using the current class as primary query
     */
    public function usePollQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPoll($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Poll', '\Poller\Model\PollQuery');
    }
