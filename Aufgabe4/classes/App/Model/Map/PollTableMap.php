...
class PollTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Poller.Model.Map.PollTableMap';
     ...
     */
    const OM_CLASS = '\\Poller\\Model\\Poll';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Poller.Model.Poll';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Poller\\Model\\Poll');
    ...
    {
        $this->addRelation('PollAnswer', '\\Poller\\Model\\PollAnswer', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':poll',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Poller\Model\Poll) { // it's a model object
