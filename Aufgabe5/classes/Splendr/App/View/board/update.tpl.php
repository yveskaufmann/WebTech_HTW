...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 col-sm-offset-6">
            <h2>Update Product Board</h2>
        </div>
    </div>

    <div class="row">
        <div class="col-sm-12">
            <form class="form-horizontal" method="POST" action="<?= URL::getControllerURL('board', 'update') ?>">
                <div class="form-group">
                    <label for="board_name" class="col-sm-2 control-label">Board Name</label>
                    <div class="col-sm-10">
                        <input type="text" name="<?= BoardController::NAME_PARAM ?>" class="form-control" id="board_name" placeholder="Board Name" readonly="readonly" value="<?= $board->getName() ?>">
                    </div>
                </div>
                <div class="form-group">
