...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Splendr.App.Model.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\Splendr\\App\\Model\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Splendr.App.Model.User';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Splendr\\App\\Model\\User');
        $this->setPackage('Splendr.App.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('username', 'Username', 'VARCHAR', true, 255, null);
        $this->addColumn('email', 'Email', 'VARCHAR', true, 320, null);
        $this->addColumn('password', 'Password', 'CHAR', true, null, null);
        $this->addColumn('salt', 'Salt', 'CHAR', true, null, null);
    ...
    {
        $this->addRelation('LoginAttempts', '\\Splendr\\App\\Model\\LoginAttempts', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Splendr\App\Model\User) { // it's a model object
