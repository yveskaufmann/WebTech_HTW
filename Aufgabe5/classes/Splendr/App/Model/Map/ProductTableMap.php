...
class ProductTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Price', 'ImageUrl', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'price', 'imageUrl', 'description', ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID, ProductTableMap::COL_NAME, ProductTableMap::COL_PRICE, ProductTableMap::COL_IMAGE_URL, ProductTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'price', 'image_url', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Price' => 2, 'ImageUrl' => 3, 'Description' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'price' => 2, 'imageUrl' => 3, 'description' => 4, ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID => 0, ProductTableMap::COL_NAME => 1, ProductTableMap::COL_PRICE => 2, ProductTableMap::COL_IMAGE_URL => 3, ProductTableMap::COL_DESCRIPTION => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'price' => 2, 'image_url' => 3, 'description' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('description', 'Description', 'LONGVARCHAR', false, null, '');
    } // initialize()
