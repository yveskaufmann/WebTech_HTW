 ...
 * @method     ChildAccountQuery orderByEnabled($order = Criteria::ASC) Order by the enabled column
 * @method     ChildAccountQuery orderByActivationKey($order = Criteria::ASC) Order by the activation_key column
 * @method     ChildAccountQuery orderByExpirationDate($order = Criteria::ASC) Order by the expiration_date column
 *
 * @method     ChildAccountQuery groupById() Group by the id column
 * @method     ChildAccountQuery groupByEnabled() Group by the enabled column
 * @method     ChildAccountQuery groupByActivationKey() Group by the activation_key column
 * @method     ChildAccountQuery groupByExpirationDate() Group by the expiration_date column
 *
 ...
 * @method     ChildAccount findOneByEnabled(int $enabled) Return the first ChildAccount filtered by the enabled column
 * @method     ChildAccount findOneByActivationKey(string $activation_key) Return the first ChildAccount filtered by the activation_key column
 * @method     ChildAccount findOneByExpirationDate(string $expiration_date) Return the first ChildAccount filtered by the expiration_date column *
 ...
 * @method     ChildAccount requireOneByEnabled(int $enabled) Return the first ChildAccount filtered by the enabled column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAccount requireOneByActivationKey(string $activation_key) Return the first ChildAccount filtered by the activation_key column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAccount requireOneByExpirationDate(string $expiration_date) Return the first ChildAccount filtered by the expiration_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildAccount[]|ObjectCollection findByEnabled(int $enabled) Return ChildAccount objects filtered by the enabled column
 * @method     ChildAccount[]|ObjectCollection findByActivationKey(string $activation_key) Return ChildAccount objects filtered by the activation_key column
 * @method     ChildAccount[]|ObjectCollection findByExpirationDate(string $expiration_date) Return ChildAccount objects filtered by the expiration_date column
...
abstract class AccountQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Splendr\App\Model\Base\AccountQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'splendr', $modelName = '\\Splendr\\App\\Model\\Account', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, enabled, activation_key, expiration_date FROM Accounts WHERE id = :p0';
        try {
    ...
    public function filterByEnabled($enabled = null, $comparison = null)
    {
        if (is_array($enabled)) {
            ...
            if (isset($enabled['min'])) {
                $this->addUsingAlias(AccountTableMap::COL_ENABLED, $enabled['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($enabled['max'])) {
                $this->addUsingAlias(AccountTableMap::COL_ENABLED, $enabled['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AccountTableMap::COL_ENABLED, $enabled, $comparison);
    }
    ...
    public function filterByActivationKey($activationKey = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AccountTableMap::COL_ACTIVATION_KEY, $activationKey, $comparison);
    }
    ...
    public function filterByExpirationDate($expirationDate = null, $comparison = null)
    {
        if (is_array($expirationDate)) {
            ...
            if (isset($expirationDate['min'])) {
                $this->addUsingAlias(AccountTableMap::COL_EXPIRATION_DATE, $expirationDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($expirationDate['max'])) {
                $this->addUsingAlias(AccountTableMap::COL_EXPIRATION_DATE, $expirationDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AccountTableMap::COL_EXPIRATION_DATE, $expirationDate, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \Splendr\App\Model\User) {
            return $this
                ->addUsingAlias(AccountTableMap::COL_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AccountTableMap::COL_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
