...
abstract class Product implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Splendr\\App\\Model\\Map\\ProductTableMap';
    ...
    /**
     * The value for the product_url field.
     * @var        string
     */
    ...
    /**
     * Get the [product_url] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [product_url] column.
     *
     * @param string $v new value
     * @return $this|\Splendr\App\Model\Product The current object (for fluent API support)
     */
    public function setProductUrl($v)
    {
        ...
        if ($this->product_url !== $v) {
            $this->product_url = $v;
            $this->modifiedColumns[ProductTableMap::COL_PRODUCT_URL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('ImageUrl', TableMap::TYPE_PHPNAME, $indexType)];
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Splendr\App\Model\Product
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Splendr\App\Model\Product The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Splendr\App\Model\Product (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Splendr\App\Model\Product Clone of current object.
     * @throws PropelException
     */
